...
namespace eCommerceApp.Host.Controllers
{
    ...
    public class ShopCategoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] CreateShopCategory dto)
        {
            ...
            if (shopId == Guid.Empty)
            {
                ...
                return StatusCode((int)HttpStatusCode.Forbidden, 
                    ServiceResponse.Fail("Người dùng hiện tại không phải là Seller hoặc chưa có Shop.", HttpStatusCode.Forbidden));
            }
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            ...
            var response = await _shopCategoryService.GetShopCategoryDetailAsync(shopId, id);
